            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <a href="{{ route('client.templates.editor', $template->id) }}" 
                                       class="btn btn-sm btn-outline-info" title="Тест редактора" target="_blank">
                        ...
                        @empty
                        <tr>
                            <td colspan="9" class="text-center">Шаблоны не найдены</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
