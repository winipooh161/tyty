        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow border-0 rounded-4">
                <div class="card-header bg-primary text-white text-center py-3">
                    <h4 class="mb-0"><?php echo e(__('Вход в аккаунт')); ?></h4>
                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center mt-4">
                            ...
                            <p class="mt-3">Нет аккаунта? <a href="<?php echo e(route('register')); ?>" class="text-decoration-none">Зарегистрироваться</a></p>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\tyty\resources\views/auth/login.blade.php ENDPATH**/ ?>